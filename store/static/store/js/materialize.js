								...
								value: function() {
									this.el.addEventListener('keydown', this._handleTriggerKeydownBound),
										this.dropdownEl.addEventListener('click', this._handleDropdownClickBound),
											...
											this.options
												.hover ? ((this._handleMouseEnterBound = this._handleMouseEnter.bind(
												this
											)),
								...
								value: function() {
									this.el.removeEventListener('keydown', this._handleTriggerKeydownBound),
										this.dropdownEl.removeEventListener('click', this._handleDropdownClickBound),
											...
											this.options.hover ? (this.el.removeEventListener(
												'mouseenter',
								...
								value: function() {
									...
									if (
										...
										var u =
											...
											l[u] ? (d = u) :
											l.spaceOnLeft > l.spaceOnRight ? ((d = 'right'),
											(n += l.spaceOnLeft),
											(s -= l.spaceOnLeft)) :
						...
						[
							...
							},
							{
								...
								value: function(t) {
										...
										(this.overlayActive && this.doneAnimating) ? this.close() :
										this.open();
								}
							},
							{
									...
									if (!1 !== this.isOpen)
										if (
											...
											this._enableBodyScrolling(),
													...
													this.isDragged &&
													0 == this.percentOpen ? (this._overlay.style.display = 'none') :
													this._animateOut();
								}
							},
							{
							...
							},
							{
								...
								value: function() {
										...
										(c._visibleElements = c._visibleElements.filter(function(t) {
											...
											this.id <
												c._visibleElements[0][0].M_ScrollSpy.id ? c._visibleElements.unshift(
												this.$el
											) :
		...
		(M.updateTextFields = function() {
			d(
				...
				var i = d(this);
					...
					d(t).is(':focus') ||
					t.autofocus ||
					null !== i.attr('placeholder') ? i.siblings('label').addClass('active') :
							...
							},
							{
								...
								value: function() {
									this.$el.hasClass('fullscreen') ||
										(
											this.options.indicators ? this.$el.css(
												'height',
		...
		n(document).on('click', '.card', function(t) {
			if (n(this).children('.card-reveal').length) {
				...
				var e = n(this).find('.card-reveal');
					...
					n(t.target).is(n('.card-reveal .card-title i')) ? s({
						targets: e[0],
						translateY: 0,
						duration: 225,
						...
						[
							...
							},
							{
								...
								value: function() {
										...
										!this.chipsData.length &&
										this.options.placeholder ? h(this.$input).prop(
											'placeholder',
					...
					[
							...
							value: function() {
								(this._handleFABClickBound = this._handleFABClick.bind(this)),
									...
									(this._handleCloseBound = this.close.bind(this)),
										...
										!this.options.toolbarEnabled ? (this.el.addEventListener(
											'mouseenter',
						...
						},
						{
							...
							value: function() {
									...
									this.options.hoverEnabled &&
									!this.options.toolbarEnabled ? (this.el.removeEventListener(
										'mouseenter',
										this._handleOpenBound
									),
						...
						},
						{
							...
							value: function() {
								this.isOpen &&
									(
										this.options.toolbarEnabled ? (window.removeEventListener(
											'scroll',
									...
									for (d = [], l = 0; l < 12; l++)
										d.push(
											'<option value="' +
												...
												(
													(c && l < u.minMonth) ||
													(p && l > u.maxMonth) ? 'disabled="disabled"' :
													'') +
												'>' +
												u.i18n.months[l] +
												'</option>'
									...
									if (this.isOpen) {
										...
										e.hasClass('is-disabled') ||
											(
												...
												e.hasClass('is-empty') ||
												e.parent().hasClass('is-disabled') ? e.closest('.month-prev')
													.length ? this.prevMonth() :
							...
							},
							{
								...
								value: function(t) {
									...
									this.moved && n === this.dx && s === this.dy && this.setHand(n, s),
											...
											'hours' === this.currentView ? this.showView(
												'minutes',
						...
						[
								...
								value: function(t) {
									if (this.pressed)
										return (
											...
											this.noWrap &&
												(
													this.target >= this.dim * (this.count - 1) ? (this.target =
							...
							},
							{
								...
								value: function(t) {
										...
										this.options.fullWidth ? ((this.itemWidth = this.$el
											.find('.carousel-item')
											.first()
											.innerWidth()),
							...
							},
							{
								...
								value: function(t) {
									var i = this,
										e =
											this.$el.find('.carousel-item.active').length ? this.$el
								...
								value: function() {
									...
									this.amplitude &&
										((t = Date.now() - this.timestamp),
											...
											2 < (e = this.amplitude * Math.exp(-t / this.options.duration)) ||
											e < -2 ? (this._scroll(this.target - e),
											requestAnimationFrame(this._autoScrollBound)) :
