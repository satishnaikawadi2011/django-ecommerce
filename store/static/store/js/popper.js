 ...
 */ (function(
	...
	function n(e) {
		...
		var i = t(e),
			...
			s = i.overflowY;
		return
			/(auto|scroll|overlay)/.test(r + s + p) ? e :
			n(o(e));
	}
	function i(e) {
		return
			e && e.referenceNode ? e.referenceNode :
			e;
	}
	function r(e) {
		return
		...
		return
			i && 'BODY' !== i && 'HTML' !== i ? -1 !==
				[
					...
					'TD',
					'TABLE'
				].indexOf(n.nodeName) && 'static' === t(n, 'position') ? p(n) :
			n :
	...
	function u(e) {
		...
		var p = { left: o.left, top: o.top, width: o.right - o.left, height: o.bottom - o.top },
			s =
					...
					'HTML' === e.nodeName ? c(e.ownerDocument) :
					{},
		...
		if ('vh' === p || 'vw' === p) {
			...
			return (
				(a =
						...
						'vh' === p ? ee(document.documentElement.clientHeight, window.innerHeight || 0) :
						...
						return
							...
							-1 !==
								[
									'+',
									'-'
								].indexOf(t) ? ((e[e.length - 1] = t), (p = !0), e) :
	...
	var Q = Math.min,
		...
		ae = function(e, t, o) {
			return (
					...
					t in e ? Object.defineProperty(e, t, { value: o, enumerable: !0, configurable: !0, writable: !0 }) :
					(e[t] = o),
				e
			);
		},
	...
	return (
		(ge.Utils = (
			'undefined' == typeof window ? global :
			window).PopperUtils),
		(ge.placements = me),
		(ge.Defaults = {
			placement: 'bottom',
					...
					fn: function(e, t) {
						...
						if (
							((d =
									...
									'bottom' == c ? 'HTML' === l.nodeName ? -l.clientHeight + h.bottom :
									-f.height + h.bottom :
									h.top),
							(s =

									'right' == g ? 'HTML' === l.nodeName ? -l.clientWidth + h.right :
									-f.width + h.right :
									h.left),
							a && b)
						)
