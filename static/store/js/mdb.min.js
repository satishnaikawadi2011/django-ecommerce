 ...
 */ !(function(
		...
		(t.exports =
			...
			function(t, e) {
				...
				return (
						...
						null !== t ? ((c.prototype = r(t)), (n = new c()), (c.prototype = null), (n[u] = t)) :
						(n = d()),
	...
	function(t, e, n) {
		...
		t.exports = function(t, e) {
			return
				arguments.length < 2 ? o(r[t]) || o(i[t]) :
				(r[t] && r[t][e]) || (i[t] && i[t][e]);
		};
	},
	function(t, e, n) {
	...
	function(t, e, n) {
		...
		t.exports = function(t, e) {
			...
			return (
				i(t) &&
					(
						'function' != typeof (n = t.constructor) || (n !== Array && !i(n.prototype)) ? r(n) &&
						null === (n = n[o]) &&
						(n = void 0) :
						(n = void 0)),
				new (
		...
		(t.exports = s(
			...
			function() {
				var t = u(this),
					...
					r = t.index++;
				return
					!e || r >= e.length ? ((t.target = void 0), { value: void 0, done: !0 }) :
			...
			function(t) {
				return (
					(t = i(t)),
						...
						r(t, s) ? t[s] :
						'function' == typeof t.constructor && t instanceof t.constructor ? t.constructor.prototype :
						t instanceof Object ? l :
						null
				);
			};
	},
	...
	function(t, e, n) {
		...
		[].keys &&
			(
				'next' in (o = [].keys()) ? (i = a(a(o))) !== Object.prototype && (r = i) :
				(f = !0)),
			null == r && (r = {}),
			c ||
				l(r, d) ||
			...
			if (!h || !p || ('replace' === t && !u) || ('split' === t && !c)) {
				var g = /./[f],
					v = n(f, ''[t], function(t, e, n, r, i) {
						return
							e.exec === s ? h && !i ? { done: !0, value: g.call(e, n, r) } :
	...
	function(t, e, n) {
		...
		t.exports = function(t) {
			...
			return
				...
				o ? r(e) :
				'Object' == (a = r(e)) && 'function' == typeof e.callee ? 'Arguments' :
				a;
		};
	},
	function(t, e, n) {
	...
	function(t, e, n) {
		...
		var r = n(3),
			...
			it =
					...
					s && 'symbol' == typeof j.iterator ? function(t) {
			...
			ot = function(t, e, n) {
				...
				return (
					f(n),
						...
						u(Q, r) ? (
							n.enumerable ? (u(t, N) && t[N][r] && (t[N][r] = !1),
			...
			(A(
				(j = function() {
					...
					var t =
								...
								arguments.length && void 0 !== arguments[0] ? String(arguments[0]) :
								void 0,
						e = I(t),
						n = function(t) {
							this === W && n.call(X, t),
			...
			var d = {},
				f = function() {
					var t =
								...
								arguments.length < 1 || void 0 === arguments[0] ? void 0 :
								String(arguments[0]),
						e =

								this instanceof f ? new c(t) :
								void 0 === t ? c() :
								c(t);
					return '' === t && (d[e] = !0), e;
				};
		...
		o(
			...
			function() {
				var t,
					...
					i = e.index;
				return
					i >= n.length ? { value: void 0, done: !0 } :
	...
	function(t, e, n) {
		var r = n(10),
			...
			a =
					...
					'object' == typeof window && window && Object.getOwnPropertyNames ? Object.getOwnPropertyNames(
						window
					) :
					[];
		t.exports.f = function(t) {
			return
				a && '[object Window]' == o.call(t) ? (function(t) {
					try {
						return i(t);
					} catch (t) {
						return a.slice();
			...
			{ target: 'Array', proto: !0, forced: !c('slice') },
			{
				slice: function(t, e) {
					...
					if (
						o(p) &&
						(
							'function' != typeof (n = p.constructor) || (n !== Array && !o(n.prototype)) ? i(n) &&
							null === (n = n[d]) &&
							(n = void 0) :
							(n = void 0),
						n === Array || void 0 === n)
				...
				function() {
					...
					return (
						...
						String(
								...
								void 0 === n && t instanceof RegExp && !('flags' in s) ? a.call(t) :
								n
						)
					);
				},
					...
					(r =
							...
							''.split(/.?/).length ? function(t, n) {
								...
								return (
										...
										p === r.length ? (!u && g.test('')) || c.push('') :
										c.push(r.slice(p)),

										c.length > o ? c.slice(0, o) :
										c
								);
							} :
					...
					(i = [
						{
							...
							value: function() {
								...
								this.$text.length &&
									((e =
										window.attachEvent ? function(t, e, n) {
						...
						},
						{
							...
							value: function(t, e) {
								...
								(e = ''.concat(e, 'Class')),
									(n =
										t.parent().hasClass('timepicker') ? 'label' :
							...
							value: function() {
								...
								this.$document.on('focus', this.inputSelector, function(n) {
									e.toggleActiveClass(t(n.target), 'add'),
										'date' == t(n.target).attr('type') && t(n.target).css('color', '#495057');
								});
							}
						},
						{
						...
						},
						{
							...
							value: function() {
								...
								this.$document.on('reset', function(n) {
									var r = t(n.target);
									r.is('form') &&
										(r.find(e.inputSelector).removeClass('valid invalid').each(function(n, r) {
											var i = t(r),
												o = !i.val(),
								...
								if (t.hasClass('validate')) {
									...
									if (n && r) t.removeClass('valid').removeClass('invalid');
										...
										var i = t[0].validity.valid,
											...
											i && (!o || o > e.length) ? t.removeClass('invalid').addClass('valid') :
							...
							e.find('.nested').hide(),
								...
								r.on('click', function() {
									...
									e.toggleClass('open'),
										r.toggleClass('down'),
											...
											n.hasClass('active') ? n.removeClass('active').slideUp() :
								...
								n.on('click', function() {
									var e = t(this);
										...
										e.hasClass('opened') ? e.removeClass('opened') :
							...
							e.find('.nested').hide(),
								...
								n.on('click', function() {
									var e = t(this);
										...
										e.hasClass('opened') ? n.removeClass('opened') :
										(n.removeClass('opened'), e.addClass('opened'));
								});
						})(e);
			};
							...
							},
							{
								...
								value: function() {
									var t = this;
										...
										this.$wowElement.css({ 'animation-name': 'none', visibility: 'hidden' })) :
										setTimeout(function() {
				...
				(r = function() {
					...
					'object' ===
						(
							...
							i(exports)) && void 0 !== t ? (t.exports = r()) :
					'function' == typeof define && n(55) ? define(r) :
				...
				})(
					{
							...
							function(t, e, n) {
								var r = t(5),
									...
									a = function t(e) {
										return
											e instanceof t ? e :
											this instanceof t ? ((this.valid = !1),
											(this.values = {
												rgb: [
													0,
													0,
											...
											void (
												'string' == typeof e ? (n = i.getRgba(e)) ? this.setValues('rgb', n) :
												(n = i.getHsla(e)) ? this.setValues('hsl', n) :
												(n = i.getHwb(e)) && this.setValues('hwb', n) :
												'object' === o(e) &&
												(
													void 0 !== (n = e).r || void 0 !== n.red ? this.setValues(
														'rgb',
														n
													) :
													void 0 !== n.l || void 0 !== n.lightness ? this.setValues(
														'hsl',
														n
													) :
													void 0 !== n.v || void 0 !== n.value ? this.setValues('hsv', n) :
													void 0 !== n.w || void 0 !== n.whiteness ? this.setValues(
														'hwb',
														n
													) :
										...
										for (var o in r)
											r.hasOwnProperty(o) &&
												((t = r[o]),
													...
													'[object Array]' === (e = {}.toString.call(t)) ? (i[o] = t.slice(
														0
													)) :
													'[object Number]' === e ? (i[o] = t) :
							...
							function(t, e, n) {
										...
										100 *
											(0.4124 *
												(e =
														...
														e > 0.04045 ? Math.pow((e + 0.055) / 1.055, 2.4) :
														e / 12.92) +
												0.3576 *
													(n =

															n > 0.04045 ? Math.pow((n + 0.055) / 1.055, 2.4) :
															n / 12.92) +
												0.1805 *
													(r =

															r > 0.04045 ? Math.pow((r + 0.055) / 1.055, 2.4) :
															r / 12.92)),
								...
								function c(t) {
									...
									return (
										...
										(n =
												...
												(n /= 95.047) > 0.008856 ? Math.pow(n, 1 / 3) :
												7.787 * n + 16 / 116),
										[
											116 *
												(r =

														r > 0.008856 ? Math.pow(r, 1 / 3) :
														7.787 * r + 16 / 116) -
												16,
											500 * (n - r),
											200 *
								...
								function v(t) {
									...
									return (
										...
										(e =
												...
												(e = 3.2406 * i + -1.5372 * o + -0.4986 * a) > 0.0031308 ? 1.055 *
													Math.pow(e, 1 / 2.4) -
												0.055 :
												(e *= 12.92)),
										(n =

												n > 0.0031308 ? 1.055 * Math.pow(n, 1 / 2.4) - 0.055 :
												(n *= 12.92)),
										(r =

												r > 0.0031308 ? 1.055 * Math.pow(r, 1 / 2.4) - 0.055 :
												(r *= 12.92)),
										[
								...
								function m(t) {
									...
									return (
										...
										(e =
												...
												(e /= 95.047) > 0.008856 ? Math.pow(e, 1 / 3) :
												7.787 * e + 16 / 116),
										[
											116 *
												(n =

														n > 0.008856 ? Math.pow(n, 1 / 3) :
														7.787 * n + 16 / 116) -
												16,
											500 * (e - n),
											200 *
								...
								function y(t) {
									...
									return (
											...
											o <= 8 ? (i = (n = 100 * o / 903.3) / 100 * 7.787 + 16 / 116) :
											((n = 100 * Math.pow((o + 16) / 116, 3)), (i = Math.pow(n / 100, 1 / 3))),
										[
											(e =

													e / 95.047 <= 0.008856 ? (e =
														95.047 * (a / 500 + i - 16 / 116) / 7.787) :
													95.047 * Math.pow(a / 500 + i, 3)),
											n,
											(r =

													r / 108.883 <= 0.008859 ? (r =
														108.883 * (i - s / 200 - 16 / 116) / 7.787) :
									...
									(e.exports = function(t) {
										(t.controllers.bar = t.DatasetController.extend({
											...
											updateElement: function(t, e, n) {
												...
												(t._xScale = r.getScaleForId(a.xAxisID)),
													...
													(t._model = {
														...
														borderSkipped:
															l.borderSkipped ? l.borderSkipped :
															u.borderSkipped,
														backgroundColor:
											...
											_getStacks: function(t) {
												var e,
													...
													o =
															...
															void 0 === t ? r.data.datasets.length :
															t + 1,
													a = [];
												for (e = 0; e < o; ++e)
											...
											getRuler: function() {
												...
												return {
													min:
														o.isNullOrUndef(n.options.barThickness) ? (function(t, e) {
															var n,
																r,
																i,
																o,
																a =
																	t.isHorizontal() ? t.width :
																	t.height,
																s = t.getTicks();
											...
											calculateBarIndexPixels: function(t, e, n) {
												var r = n.scale.options,
													i =
															...
															'flex' === r.barThickness ? (function(t, e, n) {
																var r,
																	i = e.pixels,
																	o = i[t],
																	a =
									...
									legend: {
										labels: {
											generateLabels: function(t) {
												var e = t.data;
												return
													e.labels.length && e.datasets.length ? e.labels.map(function(n, r) {
									...
									(e.exports = function(t) {
										t.controllers.doughnut = t.controllers.pie = t.DatasetController.extend({
											...
											calculateCircumference: function(t) {
												...
												return
													e > 0 && !isNaN(t) ? 2 * Math.PI * (Math.abs(t) / e) :
													0;
											},
											getMaxBorderWidth: function(t) {
												for (var e, n, r = 0, i = this.index, o = t.length, a = 0; a < o; a++)
													(e =
														t[a]._model ? t[a]._model.borderWidth :
														0),
														(r =

																(n =
																	t[a]._chart ? t[a]._chart.config.data.datasets[i]
																		.hoverBorderWidth :
																	0) >
																(r =
										...
										t.controllers.line = t.DatasetController.extend({
											...
											getPointBackgroundColor: function(t, e) {
												...
												return (
														...
														r.pointBackgroundColor ? (n = a.valueAtIndexOrDefault(
											...
											getPointBorderColor: function(t, e) {
												...
												return (
														...
														r.pointBorderColor ? (n = a.valueAtIndexOrDefault(
															r.pointBorderColor,
															e,
															n
														)) :
											...
											getPointBorderWidth: function(t, e) {
												...
												return (
														...
														isNaN(i.borderWidth) ? !isNaN(r.pointBorderWidth) ||
														a.isArray(r.pointBorderWidth) ? (n = a.valueAtIndexOrDefault(
															r.pointBorderWidth,
															e,
															n
														)) :
											...
											getPointRotation: function(t, e) {
												...
												return (
														...
														isNaN(i.rotation) ? (isNaN(r.pointRotation) &&
											...
											updateElement: function(t, e, n) {
												...
												void 0 !== c.radius &&
													...
													(t._model = {
														...
														tension:
															l.dataset._model ? l.dataset._model.tension :
															0,
												...
												return
													e.labels.length && e.datasets.length ? e.labels.map(function(n, r) {
														...
														return {
															...
															strokeStyle:
																s.borderColor ? s.borderColor :
																l(a.borderColor, r, u.borderColor),
															lineWidth:
																s.borderWidth ? s.borderWidth :
											...
											_updateRadius: function() {
												...
												(e.outerRadius = Math.max((o - i.borderWidth / 2) / 2, 0)),
													(e.innerRadius = Math.max(
															...
															r.cutoutPercentage ? e.outerRadius /
															100 *
															r.cutoutPercentage :
															1,
														0
										...
										t.controllers.radar = t.DatasetController.extend({
												...
												void 0 !== s.tension &&
													...
													o.extend(n.dataset, {
														...
														_model: {
															...
															fill:
																a.fill ? a.fill :
																void 0 !== s.fill ? s.fill :
																l.fill,
															borderCapStyle:
																a.borderCapStyle ? a.borderCapStyle :
																s.borderCapStyle || l.borderCapStyle,
															borderDash:
																a.borderDash ? a.borderDash :
																s.borderDash || l.borderDash,
															borderDashOffset:
																a.borderDashOffset ? a.borderDashOffset :
																s.borderDashOffset || l.borderDashOffset,
															borderJoinStyle:
																a.borderJoinStyle ? a.borderJoinStyle :
												...
												void 0 !== a.radius &&
													...
													o.extend(t, {
														...
														_model: {
															...
															pointStyle:
																i.pointStyle ? i.pointStyle :
																o.valueAtIndexOrDefault(a.pointStyle, e, l.pointStyle),
															rotation:
																i.rotation ? i.rotation :
																o.valueAtIndexOrDefault(a.pointRotation, e, l.rotation),
															hitRadius:
																i.hitRadius ? i.hitRadius :
																o.valueAtIndexOrDefault(
																	a.pointHitRadius,
																	e,
																	l.hitRadius
											...
											setHoverStyle: function(t) {
												...
												(t.$previousStyle = {
													...
													(i.backgroundColor =
														n.hoverBackgroundColor ? n.hoverBackgroundColor :
														o.valueAtIndexOrDefault(
															e.pointHoverBackgroundColor,
															r,
													...
													(i.borderColor =
														n.hoverBorderColor ? n.hoverBorderColor :
														o.valueAtIndexOrDefault(
															e.pointHoverBorderColor,
															r,
													...
													(i.borderWidth =
														n.hoverBorderWidth ? n.hoverBorderWidth :
														o.valueAtIndexOrDefault(
															e.pointHoverBorderWidth,
															r,
															i.borderWidth
											...
											for (var e, n, r = this.animations, o = 0; o < r.length; )
												(n = (e = r[o]).chart),
													...
													i.callback(
														...
														e.currentStep >= e.numSteps ? (i.callback(
										...
										s.extend(t.prototype, {
											...
											updateDataset: function(t) {
												var e = this.getDatasetMeta(t),
													n = { meta: e, index: t };
												!1 !==
													d.notify(this, 'beforeDatasetUpdate', [
														n
													]) &&
													(e.controller.update(),
													d.notify(this, 'afterDatasetUpdate', [
														n
													]));
											},
											render: function(t) {
											...
											drawDataset: function(t, e) {
												...
												!1 !==
													d.notify(this, 'beforeDatasetDraw', [
														r
													]) &&
													(n.controller.draw(e),
													d.notify(this, 'afterDatasetDraw', [
														r
													]));
											},
											_drawTooltip: function(t) {
												...
												!1 !==
													d.notify(this, 'beforeTooltipDraw', [
														n
													]) &&
													(e.draw(),
													d.notify(this, 'afterTooltipDraw', [
														n
													]));
											},
											...
											isDatasetVisible: function(t) {
												var e = this.getDatasetMeta(t);
												return
													'boolean' == typeof e.hidden ? !e.hidden :
											...
											eventHandler: function(t) {
												...
												if (
													...
													n &&
														(r =
															n._start ? n.handleEvent(t) :
															r | n.handleEvent(t)),
														d.notify(e, 'afterEvent', [
															t
														]);
										...
										r.extend(t.DatasetController.prototype, {
											...
											buildOrUpdateElements: function() {
												...
												o._data !== s &&
													...
													(i = o),
														...
														(t = s)._chartjs ? t._chartjs.listeners.push(i) :
											...
											setHoverStyle: function(t) {
												...
												(t.$previousStyle = {
													...
													(s.backgroundColor =
														i.hoverBackgroundColor ? i.hoverBackgroundColor :
														o(e.hoverBackgroundColor, n, a(s.backgroundColor))),
													(s.borderColor =
														i.hoverBorderColor ? i.hoverBorderColor :
														o(e.hoverBorderColor, n, a(s.borderColor))),
													(s.borderWidth =
														i.hoverBorderWidth ? i.hoverBorderWidth :
								...
								e.exports = function() {
									function t(t, e, n) {
										...
										return (
												...
												'string' == typeof t ? ((r = parseInt(t, 10)),
									...
									(o.configMerge = function() {
										return o.merge(o.clone(arguments[0]), [].slice.call(arguments, 1), {
											merger: function(t, e, n, r) {
												var i = e[t] || {},
													...
													'scales' === t ? (e[t] = o.scaleMerge(i, s)) :
													'scale' === t ? (e[t] = o.merge(i, [
														...
														for (e[t] || (e[t] = []), i = 0; i < u; ++i)
															(l = n[t][i]),
																...
																i >= e[t].length && e[t].push({}),
																	...
																	!e[t][i].type ||
																	(l.type && l.type !== e[t][i].type) ? o.merge(
																		e[t][i],
																		[
										...
										(o.findIndex =
											Array.prototype.findIndex ? function(t, e, n) {
												...
												if (!(r = d[e]).model.skip) {
													if (
														...
														r.deltaK =
																...
																0 !== h ? (i.model.y - r.model.y) / h :
																0;
													}

														!n || n.model.skip ? (r.mK = r.deltaK) :
														!i || i.model.skip ? (r.mK = n.deltaK) :
														this.sign(n.deltaK) !== this.sign(r.deltaK) ? (r.mK = 0) :
										...
										(o.getRelativePosition = function(t, e) {
											var n,
												...
												l && l.length > 0 ? ((n = l[0].clientX), (r = l[0].clientY)) :
										...
										(o._calculatePadding = function(t, e, n) {
											return
												(e = o.getStyle(t, e)).indexOf('%') > -1 ? n / parseInt(e, 10) :
												parseInt(e, 10);
										}),
										...
										(o.longestText = function(t, e, n, r) {
											...
											o.each(n, function(e) {
													...
													null != e && !0 !== o.isArray(e) ? (s = o.measureText(
														t,
														i,
														a,
														s,
							...
							function(t, e, n) {
								...
								function u(t, e, n) {
									...
									var o = l(n.axis),
										...
										c = [];
									return
										u.length ? (t.data.datasets.forEach(function(e, n) {
										...
										t.sort(function(t, n) {
											var r =
												...
												i =
													...
													n;
											return
												r.weight === i.weight ? r._tmpIndex_ - i._tmpIndex_ :
												r.weight - i.weight;
										}),
						...
						33: [
							function(t, e, n) {
								...
								function u(t, e, n) {
									return
										o.isArray(e) ? o.longestText(t, n, e) :
											...
											if (i.display && f) {
												...
												if (h) {
													...
													var C = u(t.ctx, n[0], p.font),
														...
														0 !== t.labelRotation ? ((t.paddingLeft =

																'bottom' === r.position ? S * C + 3 :
																S * b + 3),
														(t.paddingRight =

																'bottom' === r.position ? S * b + 3 :
																S * M + 3)) :
										...
										draw: function(t) {
											...
											if (n.display) {
												var i = e.ctx,
													...
													g = e.isHorizontal(),
													v =
														s.autoSkip ? e._autoSkip(e.getTicks()) :
														e.getTicks(),
													...
													_ =
															...
															'right' === n.position ? e.left :
															e.right - P - w,
													T =

															'right' === n.position ? e.left + w :
															e.right,
													I =

															'bottom' === n.position ? e.top + P :
															e.bottom - w - P,
													O =

															'bottom' === n.position ? e.top + P + w :
															e.bottom + P;
												if (
													(o.each(v, function(r, i) {
														if (!o.isNullOrUndef(r.label)) {
															var u,
																...
																i === e.zeroLineIndex &&
																n.offset === f.offsetGridLines ? ((u = f.zeroLineWidth),
																(c = f.zeroLineColor),
													...
													if (g)
														(F = e.left + (e.right - e.left) / 2),
															(D =
																	...
																	'bottom' === n.position ? e.bottom - L - C.bottom :
																	e.top + L + C.top);
													else {
												...
												if (f.drawBorder) {
													...
													var N = e.left,
														...
														g ? ((z = B =
																...
																'top' === n.position ? e.bottom :
																e.top),
														(z += W),
														(B += W)) :
														((N = V =

																'left' === n.position ? e.right :
																e.left),
														(N += W),
														(V += W)),
														i.beginPath(),
							...
							function(t, e, n) {
								...
								e.exports = {
									...
									getScaleConstructor: function(t) {
										return
											this.constructors.hasOwnProperty(t) ? this.constructors[t] :
											void 0;
									},
									getScaleDefaults: function(t) {
										return
											this.defaults.hasOwnProperty(t) ? i.merge({}, [
												r.scale,
												this.defaults[t]
											]) :
											{};
								...
								(e.exports = i.extend({
										...
										if (g.length) {
											...
											for (e = 0, n = g.length; e < n; ++e)
												k.push(
													...
													{
														xLabel:
															i ? i.getLabelForIndex(l, u) :
															'',
														yLabel:
															s ? s.getLabelForIndex(l, u) :
															'',
														index: l,
														datasetIndex: u,
														x: r._model.x,
											...
											f.filter &&
												...
												(b = (function(t, e) {
													...
													(r += l * c),
														(r +=
															l ? (l - 1) * e.titleSpacing :
															0),
														(r +=
															l ? e.titleMarginBottom :
															0),
														(r += s * d),
														(r +=
															s ? (s - 1) * e.bodySpacing :
									...
									getCaretPosition: function(t, e, n) {
										...
										if ('center' === f)
											...
											(
												'left' === d ? ((r = (i = h + c + u) - u), (o = i + u)) :
												'right' === d ? ((r = (i = h + g - c - u) - u), (o = i + u)) :
											...
											for (
												...
												(e = u[t]),
													...
													(r = e._view),
														...
														0 === t ? r.skip || (s.moveTo(r.x, r.y), (d = t)) :
														((n =
									...
									lineTo: function(t, e, n, r) {
										if (n.steppedLine)
											return (
													...
													('after' !== n.steppedLine && r) ? t.lineTo(e.x, n.y) :
													t.lineTo(n.x, e.y),
											...
											n.tension ? t.bezierCurveTo(
													...
													r ? e.controlPointPreviousY :
													e.controlPointNextY,

													r ? n.controlPointNextX :
													n.controlPointPreviousX,

													r ? n.controlPointNextY :
													n.controlPointPreviousY,
												n.x,
												n.y
											) :
									...
									i = {
										...
										_merger: function(t, e, n, r) {
											var o = e[t],
												...
												i.isObject(o) && i.isObject(a) ? i.merge(o, a, r) :
												(e[t] = i.clone(a));
										},
										_mergerIf: function(t, e, n) {
											var r = e[t],
												...
												i.isObject(r) && i.isObject(o) ? i.mergeIf(r, o) :
										...
										inherits: function(t) {
											var e = this,
												n =
														...
														t && t.hasOwnProperty('constructor') ? t.constructor :
														function() {
															return e.apply(this, arguments);
														},
												r = function() {
										...
										if (e[i]) {
											...
											[
												...
												var i = n[t];
													...
													r.isNullOrUndef(i) ? e.removeAttribute(t) :
													e.setAttribute(t, i);
											}),
									...
									if (
										(
											'start' === i ? (o =
													...
													void 0 === n.scaleBottom ? r.bottom :
													n.scaleBottom) :
											'end' === i ? (o =

													void 0 === n.scaleTop ? r.top :
													n.scaleTop) :
											void 0 !== n.scaleZero ? (o = n.scaleZero) :
											r.getBasePosition ? (o = r.getBasePosition()) :
													...
													for (t.beginPath(), a = 0, s = g + !!o; a < s; ++a)
														(c = n((u = e[(l = a % g)]._view), l, r)),
															...
															(p = d(c)),
																...
																h && p ? ((b = m.push(u)), (x = y.push(c))) :
																b &&
																x &&
																(
																	v ? (h && m.push(u), p && y.push(c)) :
																	(f(t, m, y, b, x),
																	(b = x = 0),
																	(m = []),
																	(y = [])));
									...
									legend: {
										...
										onClick: function(t, e) {
											...
											(i.hidden =
													...
													null === i.hidden ? !r.data.datasets[n].hidden :
													null),
												r.update();
										},
										onHover: null,
										labels: {
											...
											generateLabels: function(t) {
												var e = t.data;
												return
													o.isArray(e.datasets) ? e.datasets.map(function(e, n) {
														return {
															text: e.label,
															fillStyle:
																o.isArray(e.backgroundColor) ? e.backgroundColor[0] :
																e.backgroundColor,
										...
										if (
											...
											if (((a.font = h), v)) {
												var m = (t.lineWidths = [
													...
													y =
														t.legendItems.length ? c + n.padding :
														0;
												(a.textAlign = 'left'),
													(a.textBaseline = 'top'),
									...
									draw: function() {
										...
										if (e.display) {
											...
											var y = l(n, p),
												...
												x = t.isHorizontal();
											c =
												x ? { x: t.left + (s - u[0]) / 2, y: t.top + n.padding, line: 0 } :
								...
								e.exports = {
									...
									beforeUpdate: function(t) {
										var e = t.options.legend,
											...
											e ? (o.mergeIf(e, r.global.legend),

												n ? (a.configure(t, n, e), (n.options = e)) :
												c(t, e)) :
								...
								var l = i.extend({
									...
									fit: function() {
										var t = this,
											...
											s = t.minSize,
											l =
												o.isArray(n.text) ? n.text.length :
												1,
											...
											t.isHorizontal() ? ((s.width = t.maxWidth), (s.height = c)) :
									...
									var t = r.extend({
										...
										buildTicks: function() {
											...
											t.ticks =
													...
													0 === t.minIndex && t.maxIndex === e.length - 1 ? e :
										...
										getLabelForIndex: function(t, e) {
											var n = this,
												...
												i = n.isHorizontal();
											return
												r.yLabels && !i ? n.getRightValue(r.datasets[e].data[t]) :
										...
										n = t.LinearScaleBase.extend({
											determineDataLimits: function() {
												...
												(t.min =
														...
														isFinite(t.min) && !isNaN(t.min) ? t.min :
														0),
													(t.max =

															isFinite(t.max) && !isNaN(t.max) ? t.max :
															1),
											...
											getTickLimit: function() {
												...
												if (this.isHorizontal())
													t = Math.min(
															...
															e.maxTicksLimit ? e.maxTicksLimit :
															11,
											...
											getPixelForValue: function(t) {
												var e = this,
													...
													i = e.end - n;
												return
													e.isHorizontal() ? e.left + e.width / i * (r - n) :
										...
										handleTickRangeOptions: function() {
											...
											var o = void 0 !== e.min || void 0 !== e.suggestedMin,
												...
												(
													...
													(
														null === t.max ? (t.max = e.suggestedMax) :
										...
										buildTicks: function() {
											var t = this,
												...
												o = (t.ticks = (function(t, e) {
													...
													var c = (u - l) / o;
													(c =
														r.almostEquals(c, Math.round(c), o / 1e3) ? Math.round(c) :
														Math.ceil(c)),
														(i = 1),
														o < 1 &&
											...
											t.handleDirectionalChanges(),
												...
												(t.min = r.min(o)),
													...
													e.reverse ? (o.reverse(), (t.start = t.max), (t.end = t.min)) :
										...
										n = i.extend({
											...
											handleTickRangeOptions: function() {
												...
												(t.min = n(e.min, t.min)),
													...
													t.min === t.max &&
														(
															0 !== t.min && null !== t.min ? ((t.min = Math.pow(
																10,
												...
												var t = this,
													...
													o = (t.ticks = (function(t, e) {
														var n,
															...
															0 === s ? ((n = Math.floor(r.log10(e.minNotZero))),
											...
											getPixelForValue: function(e) {
												...
												return (
													(e = +l.getRightValue(e)),
														...
														u ? ((o = l.end), (a = l.start), (s = -1)) :
														((o = l.start), (a = l.end), (s = 1)),

														l.isHorizontal() ? ((n = l.width),
														(i =
															u ? l.right :
															l.left)) :
														((n = l.height),
							...
							function(t, e, n) {
								...
								e.exports = function(t) {
									...
									function s(t) {
										var e = t.options;
										return
											e.angleLines.display || e.pointLabels.display ? t.chart.data.labels.length :
											0;
									}
									function l(t) {
									...
									function u(t, e, n, r, i) {
										return
											t === r || t === i ? { start: e - n / 2, end: e + n / 2 } :
											t < r || t > i ? { start: e - n - 5, end: e } :
											{ start: e, end: e + n + 5 };
									}
									function c(t) {
										return
									...
									var p = t.LinearScaleBase.extend({
										setDimensions: function() {
											...
											t.drawingArea =
												n.display ? o / 2 - (a / 2 + r.backdropPaddingY) :
												o / 2;
										},
										determineDataLimits: function() {
											var t = this,
										...
										getTickLimit: function() {
											...
											return Math.min(
													...
													t.maxTicksLimit ? t.maxTicksLimit :
													11,
										...
										getIndexAngle: function(t) {
											return (
												t * (2 * Math.PI / s(this)) +
												(
													this.chart.options && this.chart.options.startAngle ? this.chart
														.options.startAngle :
													0) *
													Math.PI *
													2 /
										...
										getDistanceFromCenterForValue: function(t) {
											...
											return
												e.options.ticks.reverse ? (e.max - t) * n :
												(t - e.min) * n;
										},
							...
							function(t, e, n) {
								...
								function g(t, e) {
									...
									return
										...
										'string' == typeof t && 'string' == typeof i ? r(t, i) :
								...
								function v(t, e) {
									...
									return
										r.isValid() ? (n.round && r.startOf(n.round), r.valueOf()) :
										null;
								}
								function m(t) {
										...
										l =
											...
											(function(t, e, n, r) {
												...
												for (i = d.indexOf(t); i < s - 1; ++i)
													if (
														((a =
															(o = c[d[i]]).steps ? o.steps[o.steps.length - 1] :
															u),
								...
								e.exports = function() {
									var t = a.extend({
										...
										getLabelForIndex: function(t, e) {
											var n = this.chart.data,
												...
												i =
														...
														n.labels && t < n.labels.length ? n.labels[t] :
														'',
												a = n.datasets[e].data[t];
											return (
												o.isObject(a) && (i = this.getRightValue(a)),

													r.tooltipFormat ? g(i, r).format(r.tooltipFormat) :
													'string' == typeof i ? i :
										...
										getPixelForOffset: function(t) {
											var e = this,
												n =
													e._horizontal ? e.width :
													e.height,
												r =
													e._horizontal ? e.left :
													e.top,
												i = p(e._table, 'time', t, 'pos');
											return (
												r + n * (e._offsets.left + i) / (e._offsets.left + 1 + e._offsets.right)
											);
										},
										...
										getPixelForTick: function(t) {
											var e = this.getTicks();
											return
												t >= 0 && t < e.length ? this.getPixelForOffset(e[t].value) :
												null;
										},
										getValueForPixel: function(t) {
											var e = this,
 ...
 */ (e = void 0),
				(r = function(t) {
						...
						r = {
							toTextLines: function(t) {
								...
								for (t = [].concat(t); t.length; )
										...
										Array.isArray(n) ? t.push.apply(t, n) :
										e.isNullOrUndef(t) || r.unshift('' + n);
								return r;
							},
							toFontString: function(t) {
								return
									!t || e.isNullOrUndef(t.size) || e.isNullOrUndef(t.family) ? null :
									(
										t.style ? t.style + ' ' :
										'') +
									(
								...
								(o = (function(t, e) {
									for (
										...
										p | g && !(p & g);
											...
											(n = p || g) & u ? ((r = o + (f - o) * (e.top - d) / (h - d)),
											(i = e.top)) :
											n & l ? ((r = o + (f - o) * (e.bottom - d) / (h - d)), (i = e.bottom)) :
											n & s ? ((i = d + (h - d) * (e.right - o) / (f - o)), (r = e.right)) :
					...
					var f = {
							...
							rect: function(t, e) {
								...
								return (
										...
										t.horizontal ? ((r = Math.min(t.x, t.base)), (a = Math.abs(t.base - t.x))) :
					...
					h.extend(m.prototype, {
						_modelize: function(e, n, i, o) {
							...
							return {
								...
								positioner: ((a = this._el),
									...
									a instanceof t.elements.Arc ? f.arc :
									a instanceof t.elements.Point ? f.point :
									a instanceof t.elements.Rectangle ? f.rect :
									f.fallback),
								rotation:
									l(
										[
						...
						geometry: function() {
							return
								this._rects ? this._rects.frame :
								{};
						},
						rotation: function() {
							return
								this._model ? this._model.rotation :
								0;
						},
						visible: function() {
					...
					'object' ===
						(
							'undefined' == typeof exports ? 'undefined' :
							i(exports)) && void 0 !== t ? (t.exports = r(n(166))) :
			...
			jQuery.extend(jQuery.easing, {
				...
				easeInOutExpo: function(t, e, n, r, i) {
					return
						0 == e ? n :
						e == i ? n + r :
						(e /= i / 2) < 1 ? r / 2 * Math.pow(2, 10 * (e - 1)) + n :
				...
				easeInOutCirc: function(t, e, n, r, i) {
					return
						(e /= i / 2) < 1 ? -r / 2 * (Math.sqrt(1 - e * e) - 1) + n :
				...
				easeInOutElastic: function(t, e, n, r, i) {
					...
					return
						e < 1 ? s * Math.pow(2, 10 * (e -= 1)) * Math.sin((e * i - o) * (2 * Math.PI) / a) * -0.5 + n :
				...
				easeInOutBack: function(t, e, n, r, i, o) {
					return (
						null == o && (o = 1.70158),
							...
							(e /= i / 2) < 1 ? r / 2 * (e * e * ((1 + (o *= 1.525)) * e - o)) + n :
				...
				easeOutBounce: function(t, e, n, r, i) {
					return
						(e /= i) < 1 / 2.75 ? r * (7.5625 * e * e) + n :
						e < 2 / 2.75 ? r * (7.5625 * (e -= 1.5 / 2.75) * e + 0.75) + n :
						e < 2.5 / 2.75 ? r * (7.5625 * (e -= 2.25 / 2.75) * e + 0.9375) + n :
						r * (7.5625 * (e -= 2.625 / 2.75) * e + 0.984375) + n;
				},
				easeInOutBounce: function(t, e, n, r, i) {
					return
						e < i / 2 ? 0.5 * jQuery.easing.easeInBounce(t, 2 * e, 0, r, i) + n :
		...
		(function(t) {
			...
			/*! Note that this has been modified by Materialize to confirm that Velocity is not already being imported. */
					...
					if (!t.jQuery) {
						...
						(n.isWindow = function(t) {
							...
							(n.type = function(t) {
								return
									null == t ? t + '' :
									'object' == r(t) || 'function' == typeof t ? o[s.call(t)] || 'object' :
									r(t);
							}),
							(n.isArray =
								Array.isArray ||
							...
							(n.fn = n.prototype = {
								...
								offset: function() {
									var e =
										this[0].getBoundingClientRect ? this[0].getBoundingClientRect() :
										{ top: 0, left: 0 };
									return {
										top:
											e.top +
								...
								position: function() {
									...
									var e = this[0],
										...
										r = this.offset(),
										i =
											/^(?:body|html)$/i.test(t.nodeName) ? { top: 0, left: 0 } :
											n(t).offset();
									return (
				...
				(e = function() {
					return (function(t, e, n, i) {
						...
						function u(t, e) {
							...
							return (
									...
									g.isString(t) ? b.Easings[t] || (n = !1) :
									(n =

											g.isArray(t) && 1 === t.length ? s.apply(null, t) :
											g.isArray(t) && 2 === t.length ? x.apply(
												null,
												t.concat([
													e
												])
								...
								!1 === n &&
									(n =
										b.Easings[b.defaults.easing] ? b.defaults.easing :
										y),
								n
							);
						}
												...
												x))
													if ('element' !== M) {
														var A,
															P = x[M],
															_ =
																g.isString(P.easing) ? b.Easings[P.easing] :
																P.easing;
														if (1 === v) A = P.endValue;
														else {
						...
						if (!(7 >= h)) {
							...
							var w = (b.CSS = {
									...
									register: function() {
										for (var t = 0; t < w.Lists.colors.length; t++) {
											var e =
													...
													'color' === w.Lists.colors[t] ? '0 0 0 1' :
													'255 255 255 1';
										...
										clip: function(t, e, n) {
											switch (t) {
												...
												case 'extract':
													var r;
													return (r =
														w.RegEx.wrappedValueAlreadyExtracted.test(n) ? n :
														(r = n.toString().match(w.RegEx.valueUnwrap)) ? r[1].replace(
															/,(\s+)?/g,
															' '
														) :
														n);
												...
												w.Normalizations.registered[e] = function(t, n, r) {
													switch (t) {
														...
														case 'extract':
															return
																a(n) === i ||
																a(n).transformCache[e] === i ? /^scale/i.test(e) ? 1 :
																0 :
															...
															if (w.RegEx.wrappedValueAlreadyExtracted.test(r)) o = r;
																...
																var a,
																	...
																	/^[A-z]+$/i.test(r) ? (a =
																			...
																			s[r] !== i ? s[r] :
																			s.black) :
																	w.RegEx.isHex.test(r) ? (a =
																		'rgb(' + w.Values.hexToRgb(r).join(' ') + ')') :
								...
								Values: {
									...
									getDisplayType: function(t) {
										...
										return
											...
											/^(li)$/i.test(e) ? 'list-item' :
											/^(tr)$/i.test(e) ? 'table-row' :
											/^(table)$/i.test(e) ? 'table' :
											/^(tbody)$/i.test(e) ? 'table-row-group' :
											'block';
									},
									...
									function s(t, n) {
										...
										if (8 >= h) l = f.css(t, n);
											...
											(u =
													...
													a(t) === i ? e.getComputedStyle(t, null) :
													a(t).computedStyle ? a(t).computedStyle :
													(a(t).computedStyle = e.getComputedStyle(t, null))),
												'borderColor' === n && (n = 'borderTopColor'),
												('' ===
													(l =

															9 === h && 'filter' === n ? u.getPropertyValue(n) :
															u[n]) ||
													null === l) &&
													(l = t.style[n]),
												r();
								...
								setPropertyValue: function(t, n, r, i, o) {
									...
									if ('scroll' === n)
											...
											o.container ? (o.container['scroll' + o.direction] = r) :
											'Left' === o.direction ? e.scrollTo(r, o.alternateValue) :
										...
										if (
											...
											try {
												...
												a(t) && a(t).isSVG && w.Names.SVGAttribute(n) ? t.setAttribute(n, r) :
												(t.style[s] = r);
								...
								flushTransformCache: function(t) {
									...
									if ((h || (b.State.isAndroid && !b.State.isChrome)) && a(t).isSVG) {
										...
										f.each(a(t).transformCache, function(t) {
												...
												/^translate/i.test(t) ? (t = 'translate') :
												/^scale/i.test(t) ? (t = 'scale') :
							...
							var S = function t() {
								...
								function s() {
									function t(t) {
										...
										if ('scroll' === P) {
											var m,
												...
												M,
												A =
													/^x$/i.test(s.axis) ? 'Left' :
													'Top',
												T = parseFloat(s.offset) || 0;

												s.container ? g.isWrapped(s.container) ||
												g.isNode(s.container) ? ((s.container = s.container[0] || s.container),
												(M =
											...
											y)) {
												...
												if (
													...
													((s.display !== i && null !== s.display && 'none' !== s.display) ||
														...
														(z = 0),
															...
															s._cacheValues && I && I[D] ? (z === i &&
																(z = I[D].endValue + I[D].unitType),
															(W = a(o).rootPropertyValueCache[B])) :
															w.Hooks.registered[D] ? z === i ? ((W = w.getPropertyValue(
																o,
																B
															)),
													...
													if (
														...
														'%' === H &&
															(
																/^(fontSize|lineHeight)$/.test(D) ? ((N /= 100),
																(H = 'em')) :
																/^scale/.test(D) ? ((N /= 100), (H = '')) :
													...
													(l[D] = {
														...
														b.debug &&
															console.log(
																'tweensContainer (' + D + '): ' + JSON.stringify(l[D]),
																o
															);
												}
												else
									...
									!1 !== b.mock &&
										...
										(s.mobileHA = s.mobileHA && b.State.isMobile && !b.State.isGingerbread),
											...
											!1 === s.queue ? s.delay ? setTimeout(t, s.delay) :
											t() :
											f.queue(o, s.queue, function(e, n) {
												return
													!0 === n ? (_.promise && _.resolver(v), !0) :
								...
								if (
									(
										g.isWrapped(this) ? ((l = !1), (p = 0), (v = this), (h = this)) :
										((l = !0),
										(p = 1),
										(v =
											S ? arguments[0].elements || arguments[0].e :
											arguments[0])),
									(v = o(v)))
								) {
									...
									if (!/^(stop|finish)$/i.test(y) && !f.isPlainObject(x)) {
										...
										for (var A = M; A < arguments.length; A++)
												...
												(!/^(fast|normal|slow)$/i.test(arguments[A]) &&
													!/^\d/.test(arguments[A])) ? g.isString(arguments[A]) ||
												g.isArray(arguments[A]) ? (x.easing = arguments[A]) :
																	...
																	i === r &&
																		((!0 === x || g.isString(x)) &&
																			...
																			'stop' === y ? (a(i) &&
																				a(i).tweensContainer &&
																				!1 !== o &&
																				f.each(a(i).tweensContainer, function(
																					t,
																					e
																				) {
										...
										default:
											if (!f.isPlainObject(y) || g.isEmptyObject(y)) {
												if (g.isString(y) && b.Redirects[y]) {
													...
													return (
														...
														f.each(v, function(t, e) {
																...
																parseFloat(E.stagger) ? (E.delay =
																	O + parseFloat(E.stagger) * t) :
												...
												return (
														...
														_.promise ? _.rejecter(new Error(F)) :
														console.log(F),
													r()
												);
											}
										...
										b.Redirects['slide' + e] = function(t, n, r, o, a, s) {
											...
											l.display === i &&
												(l.display =
														...
														'Down' === e ? 'inline' ===
														b.CSS.Values.getDisplayType(t) ? 'inline-block' :
														'block' :
														'none'),
												(l.begin = function() {
					...
					'object' == r(t) && 'object' == r(t.exports) ? (t.exports = e()) :
					'function' == typeof define && n(55) ? define(e) :
					e());
		}.call(this, n(87)(t)));
	},
	function(t, e, n) {
	...
	function(t, e, n) {
		...
		var r = n(3),
			...
			Y = function(t, e, n) {
				return
					!(U(t, (e = g(e, !0))) && y(n) && v(n, 'value')) ||
					v(n, 'get') ||
					v(n, 'set') ||
					n.configurable ||
					(v(n, 'writable') && !n.writable) ||
					(v(n, 'enumerable') && !n.enumerable) ? I(t, e, n) :
					((t[e] = n.value), t);
			};

			o ? (R || ((A.f = $), (M.f = Y), H(z, 'buffer'), H(z, 'byteOffset'), H(z, 'byteLength'), H(z, 'length')),
			r({ target: 'Object', stat: !0, forced: !R }, { getOwnPropertyDescriptor: $, defineProperty: Y }),
			(t.exports = function(t, e, n, o) {
				var s =
						t +
						(
					...
					((v = n(function(t, n, r, i) {
						return (
							u(t, v, s),
								...
								y(n) ? q(n) ? void 0 !== i ? new g(n, p(r, e), i) :
								void 0 !== r ? new g(n, p(r, e)) :
								new g(n) :
								W(n) ? j(v, n) :
								S.call(v, n) :
								new g(h(n))
					...
					((v = n(function(t, n, r, i) {
						...
						for (T(t, { buffer: o, byteOffset: d, byteLength: a, length: l, view: new L(o) }); c < l; )
							A(t, c++);
					})),
					x && x(v, V),
					(m = v.prototype = b(z))),
					...
					var u = {
							...
							show: function(t, e, n) {
								...
								var i = s(e),
									...
									'touches' in t && t.touches.length ? ((o = t.touches[0].pageY - i.top),
								...
								(i = (n = t[o]).tagName.toLowerCase()),
									-1 !==
										[
											'input',
											'img'
										].indexOf(i) && (c[i](n), (n = n.parentElement)),
