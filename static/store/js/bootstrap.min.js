...
!(function(t, e) {
	...
	(e =
		...
		(n =
				...
				n && Object.prototype.hasOwnProperty.call(n, 'default') ? n.default :
				n);
	function l(t) {
		var n = this,
			i = !1;
	...
	var c = {
		...
		getTransitionDurationFromElement: function(t) {
			...
			var n = e(t).css('transition-duration'),
				...
				s = parseFloat(i);
			return
				o || s ? ((n = n.split(',')[0]), (i = i.split(',')[0]), 1e3 * (parseFloat(n) + parseFloat(i))) :
				0;
		},
		reflow: function(t) {
				...
				if (Object.prototype.hasOwnProperty.call(n, i)) {
					var o = n[i],
						...
						r =
								...
								s && c.isElement(s) ? 'element' :
								null === (a = s) || 'undefined' == typeof a ? '' + a :
		...
		e(window).on('load.bs.button.data-api', function() {
			for (
				...
				var i = t[e],
					...
					o.checked || o.hasAttribute('checked') ? i.classList.add('active') :
			...
			for (
				...
				var a = t[s];
					...
					'true' === a.getAttribute('aria-pressed') ? a.classList.add('active') :
			...
			return (
				...
				(n._addTouchEventListeners = function() {
					...
					if (this._touchSupported) {
						var n = function(e) {
									...
									t._pointerEvent && y[e.originalEvent.pointerType.toUpperCase()] ? (t.touchStartX =
							...
							return t.preventDefault();
								...
								e(this._element).on('touchmove.bs.carousel', function(e) {
									return (function(e) {
											...
											e.originalEvent.touches.length > 1 ? (t.touchDeltaX = 0) :
				...
				(n._getItemByDirection = function(t, e) {
					...
					var r =
						...
						this._items.length;
					return
						-1 === r ? this._items[this._items.length - 1] :
						this._items[r];
				}),
				...
				(n._slide = function(t, n) {
					...
					if (
						(
							'next' === t ? ((i = 'carousel-item-left'), (o = 'carousel-item-next'), (s = 'left')) :
	...
	var w = 'collapse',
		...
		D = (function() {
			function t(t, e) {
				...
				(this._parent =
					this._config.parent ? this._getParent() :
					null),
			...
			return (
						...
						(this._parent &&
							0 ===
								(n = [].slice
									...
									.filter(function(t) {
										return
											'string' == typeof o._config.parent ? t.getAttribute('data-parent') ===
											o._config.parent :
				...
				(n._getDimension = function() {
					return
						e(this._element).hasClass('width') ? 'width' :
						'height';
				}),
			...
			return (
						...
						if ((e(r).trigger(s), !s.isDefaultPrevented())) {
							if (!this._inNavbar && i) {
								...
								var a = this._element;
									...
									'parent' === this._config.reference ? (a = r) :
				...
				(i._getPlacement = function() {
					...
					return (
							...
							t.hasClass('dropup') ? (n =
								e(this._menu).hasClass('dropdown-menu-right') ? 'top-end' :
								'top-start') :
							t.hasClass('dropright') ? (n = 'right-start') :
							t.hasClass('dropleft') ? (n = 'left-start') :
				...
				(i._getOffset = function() {
					...
					return (
							...
							'function' == typeof this._config.offset ? (e.fn = function(e) {
								return (
									(e.offsets = a(a({}, e.offsets), t._config.offset(e.offsets, t._element) || {})), e
								);
							}) :
			...
			return (
				...
				(n._showElement = function(t) {
					var n = this,
						...
						o =
							this._dialog ? this._dialog.querySelector('.modal-body') :
							null;
					(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE) ||
						...
						this._element.setAttribute('aria-modal', !0),
							...
							e(this._dialog).hasClass('modal-dialog-scrollable') && o ? (o.scrollTop = 0) :
				...
				(n._showBackdrop = function(t) {
					var n = this,
						i =
							e(this._element).hasClass('fade') ? 'fade' :
							'';
			...
			return (
				...
				(i.show = function() {
					...
					if (this.isWithContent() && this._isEnabled) {
						...
						var l =
									...
									'function' == typeof this.config.placement ? this.config.placement.call(
										this,
										r,
										this.element
									) :
					...
					return (
						t ||
							(t =
									...
									'function' == typeof this.config.title ? this.config.title.call(this.element) :
									this.config.title),
						t
					);
				}),
				...
				(i._getOffset = function() {
					...
					return (
							...
							'function' == typeof this.config.offset ? (e.fn = function(e) {
								return (
				...
				(i._getContainer = function() {
					return
						!1 === this.config.container ? document.body :
					...
					this.config.trigger.split(' ').forEach(function(n) {
						if ('click' === n)
							...
							var i =
										...
										'hover' === n ? t.constructor.Event.MOUSEENTER :
										t.constructor.Event.FOCUSIN,
								o =

										'hover' === n ? t.constructor.Event.MOUSELEAVE :
					...
					(n = n || e(t.currentTarget).data(i)) ||
						...
						t &&
							(n._activeTrigger[
									...
									'focusin' === t.type ? 'focus' :
									'hover'
							] = !0),

							e(n.getTipElement()).hasClass('show') || 'show' === n._hoverState ? (n._hoverState =
								'show') :
		...
		lt = (function() {
			...
			return (
				(n.refresh = function() {
					var t = this,
						n =
								...
								this._scrollElement === this._scrollElement.window ? 'offset' :
								'position',
						i =

								'auto' === this._config.method ? n :
								this._config.method,
						o =

								'position' === i ? this._getScrollTop() :
								0;
					(this._offsets = []),
						(this._targets = []),
				...
				(n._getScrollTop = function() {
					return
						this._scrollElement === window ? this._scrollElement.pageYOffset :
				...
				(n._getOffsetHeight = function() {
					return
						this._scrollElement === window ? window.innerHeight :
		...
		ht = (function() {
			...
			return (
					...
					if (
						...
						if (o) {
							var r =
									...
									'UL' === o.nodeName || 'OL' === o.nodeName ? '> li > .active' :
									'.active';
						...
						if (
							...
							var h = function() {
								...
								n ? this._activate(n, n.parentNode, h) :
								h();
						}
					}
				}),
				...
				(n._activate = function(t, n, i) {
					var o = this,
						s = (
							!n || ('UL' !== n.nodeName && 'OL' !== n.nodeName) ? e(n).children('.active') :
